...
birdImage.src = './ToneBird/assets/flappy.png';

const tubeImage = new Image();
tubeImage.src = './ToneBird/assets/tube_bottom.png';

const tubeTopImage = new Image();
tubeTopImage.src = './ToneBird/assets/tube_top.png';


const tubeRImage = new Image();
tubeRImage.src = './ToneBird/assets/tube_bottomr.png';

const tubeTopRImage = new Image();
tubeTopRImage.src = './ToneBird/assets/tube_topr.png';
